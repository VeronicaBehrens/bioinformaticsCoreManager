...
#SBATCH --output=logs_11_flair_quantify/chr22_log.out
#SBATCH --error=logs_11_flair_quantify/chr22_log.err
#SBATCH --time=2:00:00
...
ISOFORMS_DIR=/labs/kingsley/vbehrens/TADaptations/Isoseq_Kinnex_tetraploids/scripts/SQANTI3_filter_output
...
FASTA_OF_COLLAPSED_ISOFORMS=${ISOFORMS_DIR}/chr22ONLY-allSamples.filtered.fasta
...
##### QUANTIFY ISOFORM USAGE FOR ALL SAMPLES BY MAPPING TO THE UNIFIED SET OF ISOFORMS #####
##### AFTER THIS STEP, ALL FILES NECESSARY FOR DIFFERENTIAL ISOFORM USAGE USING TAPPAS ARE READY #####
##### NOTE: tappas is a point-and-click GUI that runs locally, so this is end of pipeline #####
flair quantify \
