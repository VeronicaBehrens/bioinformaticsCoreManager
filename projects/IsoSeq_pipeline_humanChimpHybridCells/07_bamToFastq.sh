...
#SBATCH --output=logs_07_bamToFastq/chr22_log.out
#SBATCH --error=logs_07_bamToFastq/chr22_log.err
#SBATCH --time=0:30:00
...
IN_BAM=${SAMPLE}.fl.aligned_hg38.sorted.MAPq0removed_chr22ONLY.bam
OUT_FASTQ=${SAMPLE}.fl.aligned_hg38.sorted.MAPq0removed_chr22ONLY.fastq
THREADS=4

### SAM TO FASTQ ###
samtools fastq --threads $THREADS $IN_BAM > $OUT_FASTQ
pigz --processes $THREADS $OUT_FASTQ
